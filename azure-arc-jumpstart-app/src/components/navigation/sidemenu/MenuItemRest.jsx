import "./MenuItemRest.css";

const MenuItemRest = ({ ...props }) => {
  return (
    <div className="menu-item-rest">
      <div className="menu-item-rest-start-content">
        {showIcon && (
          <>
            <svg
              className="menu-item-rest-regular-icon"
              width="16"
              height="21"
              viewBox="0 0 16 21"
              fill="none"
        ...
        <div className="menu-item-rest-content-frame">
          <div className="menu-item-rest-list-item-text">Action </div>
        </div>
      </div>
    </div>
  );
