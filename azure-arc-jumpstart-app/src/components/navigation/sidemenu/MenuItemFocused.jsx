import "./MenuItemFocused.css";

const MenuItemFocused = ({ ...props }) => {
  return (
    <div className="menu-item-focused">
      <div className="menu-item-focused-start-content">
        {showIcon && (
          <>
            <svg
              className="menu-item-focused-regular-icon"
              width="16"
              height="21"
              viewBox="0 0 16 21"
              fill="none"
        ...
        <div className="menu-item-focused-content-frame">
          <div className="menu-item-focused-list-item-text">Action </div>
        </div>
      </div>
    </div>
  );
...
export default MenuItemFocused;
