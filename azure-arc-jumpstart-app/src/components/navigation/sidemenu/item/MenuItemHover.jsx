import "./MenuItemHover.css";

const MenuItemHover = ({ ...props }) => {
  return (
    <div className="menu-item-hover">
      <div className="menu-item-hover-start-content">
        {showIcon && (
          <>
            <svg
              className="menu-item-hover-regular-icon"
              width="16"
              height="21"
              viewBox="0 0 16 21"
              fill="none"
        ...
        <div className="menu-item-hover-content-frame">
          <div className="menu-item-hover-list-item-text">Action </div>
        </div>
      </div>
    </div>
  );
