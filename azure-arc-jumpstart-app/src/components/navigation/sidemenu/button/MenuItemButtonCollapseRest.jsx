import "./MenuItemButtonCollapseRest.css";

const MenuItemButtonCollapseRest = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-item-button-collapse-rest">
      <div className="menu-item-button-collapse-rest-rectangle-34656628"></div>
      <svg
        className="menu-item-button-collapse-rest-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
...
export default MenuItemButtonCollapseRest;
