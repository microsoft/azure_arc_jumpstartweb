import "./MenuItemButtonCollapseHover.css";

const MenuItemButtonCollapseHover = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-button-collapse-hover">
      <div className="menu-button-collapse-hover-rectangle-34656628"></div>
      <svg
        className="menu-button-collapse-hover-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
...
export default MenuItemButtonCollapseHover;
