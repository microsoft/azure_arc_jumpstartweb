import "./MenuItemButtonExpandRest.css";

const MenuItemButtonExpandRest = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-item-button-expand-rest">
      <div className="menu-item-button-expand-rest-rectangle-34656628"></div>
      <svg
        className="menu-item-button-expand-rest-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
...
export default MenuItemButtonExpandRest;
