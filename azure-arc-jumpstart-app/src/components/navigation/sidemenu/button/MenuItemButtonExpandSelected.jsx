import "./MenuItemButtonExpandSelected.css";

export const MenuItemButtonExpandSelected = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-item-button-expand-selected">
      <div className="state-selected-type-expand-rectangle-34656628"></div>
      <svg
        className="state-selected-type-expand-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
