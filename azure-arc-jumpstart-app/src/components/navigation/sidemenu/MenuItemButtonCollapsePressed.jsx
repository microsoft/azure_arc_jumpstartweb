import "./MenuItemButtonCollapsePressed.css";

const MenuItemButtonCollapsePressed = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-item-button-collapse-pressed">
      <div className="menu-item-button-collapse-pressed-rectangle-34656628"></div>
      <svg
        className="menu-item-button-collapse-pressed-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
...
export default MenuItemButtonCollapsePressed;
