import "./MenuItemButtonExpandHover.css";

const MenuItemButtonExpandHover = ({
  state = "rest",
  type = "collapse",
  ...props
}) => {
  return (
    <div className="menu-item-button-expand-hover">
      <div className="menu-item-button-expand-hover-rectangle-34656628"></div>
      <svg
        className="menu-item-button-expand-hover-chevron"
        width="32"
        height="24"
        viewBox="0 0 32 24"
        fill="none"
...
export default MenuItemButtonExpandHover;
