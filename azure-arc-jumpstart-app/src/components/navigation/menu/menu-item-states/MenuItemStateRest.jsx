import "./MenuItemStateRest.css";

const MenuItemStateRest = ({
  showIcon = true,
  state = "rest",
  action = "closed",
  tab = "getting-started",
  ...
  return (
    <div className="menu-item-rest-state">
      {showIcon && (
        <>
          <div className="menu-item-rest-state-frame-59941">
            <div className="menu-item-rest-state-solutions">Solutions </div>
            <svg
              className="menu-item-rest-state-chevron"
              width="14"
              height="15"
              viewBox="0 0 14 15"
              fill="none"
...
export default MenuItemStateRest;
